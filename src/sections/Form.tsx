        ...
        <div className='flex flex-col gap-6'>
            <div className='flex flex-col gap-2'>
                ...
                >
                    ...
                    {formData.avatar ? (
                        <div className="flex flex-row gap-4 text-neutral-100 items-center justify-center relative">
                            <button className="p-1 text-xs rounded-md bg-neutral-50/10 hover:text-red-200" id="changeImage" type="button" onClick={() => setFormData(prev => ({...prev, avatar: null}))}>Remove Image</button>
                            <button className="p-1 text-xs rounded-md bg-neutral-50/10 hover:text-red-200" id="deleteImage" type="button">Change Image</button>
                        </div>
                    ) : (
                ...
                <div className='flex items-center gap-2 text-xs text-neutral-500'>
                    <Info size={'1rem'}/>Upload your photo (JPG or PNG, max size: 500Kb).
                </div>
            </div>
            <div className='flex flex-col gap-2'>
                <label className="block text-xl text-neutral-300">
